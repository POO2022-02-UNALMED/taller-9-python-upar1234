...
boton_menos = Button(root, text="-", width=9, height=3, bg="deep sky blue", fg="black", borderwidth=0, cursor="hand2", command=lambda:ag_pantalla("-")).grid(row=1, column=3, padx=1, pady=1)
